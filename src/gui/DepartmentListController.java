...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	@FXML private TableColumn<Department, Department> columnEDIT;
	@FXML private TableColumn<Department, Department> columnDELETE;
	...
	private void initRemoveButtons() {
		...
		columnDELETE.setCellFactory(param -> new TableCell<Department, Department>() {
	...
	private void removeEntity(Department obj) {
		...
		if(answer.get() == ButtonType.OK) {
			...
			try {
				...
				Alerts.showAlert("Couldn't remove department.", null, e.getMessage(), AlertType.ERROR);
			}
